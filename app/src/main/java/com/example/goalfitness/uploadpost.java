...
public class uploadpost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.uploadpost);
    ...
    private void uploadImage_10(){
        ...
        if (mImageUri != null){
            ...
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(uploadpost.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            Toast.makeText(uploadpost.this, "No image selected", Toast.LENGTH_SHORT).show();
        }
    }
