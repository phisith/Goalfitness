...
import com.example.goalfitness.EditProfileActivity2;
...
public class ProfileFragment2 extends Fragment {
    ...
    private void userInfo(){ //
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users").child("Personal trainer").child(profileid);
